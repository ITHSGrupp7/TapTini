...
import {Drink} from "../service/Service"
  ...
  const drinkItem = (drink: Drink) => (
    <div key={drink.idDrink} className="drink-choice">
      <NavLink to="/tempoutput">
        <img className="drink-choise-img" src={drink.strDrinkThumb} onClick={() => props.callback(drink)} />
      </NavLink>
        ...
        showAll ?
          ...
          <div className="drink-container">
            ...
            <div className="btn-container">
              <NavLink to="/tempoutput">
                <button className="drink-btn" onClick={() => props.callback(setDrinkSuggestion())}>Välj denna drink</button>
              </NavLink>
